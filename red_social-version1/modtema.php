<?php
   ...
   $query="SELECT id_tema,nombre_tema,id_admin FROM tema where id_tema=$id_tema";
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">Datos Admin</div>
                                ...
                                <div class="panel-body">
                                   <form role="form" action="mod_tema.php?id_tema=<?php echo $row['id_tema'];?>" enctype="multipart/form-data" method="POST" name="modificar_tema">
                     
                        <div class="form-group">
                           <label>Nombre</label>
                           <input class="form-control" placeholder="nombre_tema" name="nombre_tema"  value="<?php echo $row['nombre_tema'];?>">
                        </div>
