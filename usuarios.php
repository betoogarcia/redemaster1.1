<?php
   ...
   $query="SELECT id_admin, nombre, apellido, user_admin, passwd, foto FROM admin";
                        ...
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                           ...
                           <nav class="nav-primary hidden-xs">
                              <ul class="nav">
                                 ...
                                 <li > <a href="user.php" > <b class="badge bg-danger pull-right"></b> <i class="glyphicon glyphicon-user icon"> <b class="bg-primary dker"></b> </i> <span>Usuarios</span> </a> </li>
                                   <li >
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">Datos Admin</div>
                                ...
                                <span class="glyphicon glyphicon-heart-empty"></span>   </a></td>
                                              <td> <a href="eliminaradmin.php?id_admin=<?php echo $row['id_admin'];?>" class="btn btn-info btn-lg btn-danger">
                                <span class="glyphicon glyphicon-remove"></span>
                              </a></td>
                                      </tr>

                                      <?php } ?>
                                      <tr><a href="registro.html"class="btn btn-info btn-lg btn-success">
