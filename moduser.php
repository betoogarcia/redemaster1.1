<?php
   ...
   $query="SELECT id_user, nombre, apellido, user_usuario, foto,passwd FROM usuario where id_user=$id_user";
                        ...
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                           ...
                           <nav class="nav-primary hidden-xs">
                              <ul class="nav">
                                 ...
                                 <li > <a href="user.php" > <i class=" glyphicon glyphicon-chevron-left icon"> <b class="bg-info"></b> </i> <span>Volver</span> </a> </li>
                              </ul>
                           </nav>
                           <!-- / nav -->
                        </div>
                  ...
                  <section class="vbox">
                     <section class="scrollable">
                       <div class="row">
                          ...
                          <div class="panel panel-default">
                            <div class="panel-heading">Datos usuario</div>
                                ...
                                <div class="panel-body">
                                   <form role="form" action="mod_user.php?id_user=<?php echo $row['id_user'];?>" enctype="multipart/form-data" method="POST" name="modificar_admin">
                        ...
                        <div class="form-group">
                           <label>usuario</label>
                           <input class="form-control" placeholder="user_suario" name="user_usuario" value="<?php echo $row['user_usuario'];?>">
                        </div>
