<?php
   ...
   $query="SELECT publicacion.id_publicacion, publicacion.texto, publicacion.imagen, publicacion.gusta, usuario.nombre, tema.nombre_tema from publicacion INNER JOIN usuario on publicacion.id_publicacion=usuario.id_user INNER JOIN tema on tema.id_tema=publicacion.id_publicacion";
                           ...
                           <nav class="nav-primary hidden-xs">
                              <ul class="nav">
                                <li >
                                 ...
                                 <li >
                                    <a href="tema.php" > <i class="fa fa-columns icon"> <b class="bg-warning"></b> </i> <span class="pull-right"><i class="fa fa-angle-up text-active"></i> </span> <span>Tema</span> </a>
                                  </li>
                            ...
                            <div class="panel-heading">Datos Admin</div>
                                ...
                                <div class="panel-body">
                                  <table  class="table table-hover" >
                                      ...
                                      <tr>
                                        <th data-field="name" data-sortable="true" >Texto</th>
                                        <th data-field="name" data-sortable="true" >Imagen</th>
                                          <th data-field="name" data-sortable="true" >Gusta</th>
                                      ...
                                      <tr>
                                        ...
                                        <td> <?php echo $row['gusta']; ?></td>
                                        <td> <?php echo $row['nombre']; ?></td>
                                        <td> <?php echo $row['nombre_tema']; ?></td>
                                        
                                        <td> <a href="modpublicacion.php?id_publicacion=<?php echo $row['id_publicacion'];?>" class="btn btn-info btn-lg ">
                                <span class="glyphicon glyphicon-heart-empty"></span>   </a></td>
                                              <td> <a href="eliminarpublicacion.php?id_publicacion=<?php echo $row['id_publicacion'];?>" class="btn btn-info btn-lg btn-danger">
                                <span class="glyphicon glyphicon-remove"></span>
                              </a></td>
                                      </tr>

                                      <?php } ?>
                                      <tr><a href="publicar.html"class="btn btn-info btn-lg btn-success">
