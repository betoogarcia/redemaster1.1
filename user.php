<?php
   ...
   $query="SELECT id_user, nombre, apellido, user_usuario, passwd, foto FROM usuario";
                        ...
                        <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="5px" data-color="#333333">
                           ...
                           <nav class="nav-primary hidden-xs">
                              <ul class="nav">
                                 ...
                                 <li > <a href="usuarios.php" > <b class="badge bg-danger pull-right"></b> <i class="glyphicon glyphicon-user icon"> <b class="bg-primary dker"></b> </i> <span>Administrador</span> </a> </li>
                                   <li >
                                    <a href="tema.php" > <i class="fa fa-columns icon"> <b class="bg-warning"></b> </i> <span class="pull-right"> <i class="fa fa-angle-down text"></i> <i class="fa fa-angle-up text-active"></i> </span> <span>Tema</span> </a>
                                  </li>
                                
                                 <li > <a href="admin.php" > <i class="glyphicon glyphicon-list-alt icon"> <b class="bg-info"></b> </i> <span>Volver</span> </a> </li>
                              </ul>
                           </nav>
                           <!-- / nav -->
                        </div>
                                  ...
                                  <table  class="table table-hover" >
                                      ...
                                      <tr>
                                        ...
                                        <th data-field="name" data-sortable="true" >Nombre</th>
                                          ...
                                          <th data-field="name" data-sortable="true">Contraseña</th>
                                          <th data-field="name" data-sortable="true">Foto</th>
                                      ...
                                      <tr>
                                        ...
                                        <td> <a href="moduser.php?id_user=<?php echo $row['id_user'];?>" class="btn btn-info btn-lg ">
                                <span class="glyphicon glyphicon-heart-empty"></span>   </a></td>
                                              <td> <a href="eli_user.php?id_user=<?php echo $row['id_user'];?>" class="btn btn-info btn-lg btn-danger">
                                <span class="glyphicon glyphicon-remove"></span>
                              </a></td>
                                      </tr>

                                      <?php } ?>
                                      <tr><a href="registrouser.html"class="btn btn-info btn-lg btn-success">
...
<!--
   ...
   $query="SELECT id_admin, nombre, apellido, user_usuario, passwd, foto FROM admin";
                        ...
                        <div class="col-lg-12">
                          <div class="panel panel-default">
                            <div class="panel-heading">Datos Admin</div>
                                ...
                                <span class="glyphicon glyphicon-heart-empty"></span>   </a></td>
                                              <td> <a href="eli_admin.php?id_admin=<?php echo $row['id_admin'];?>" class="btn btn-info btn-lg btn-danger">
                                <span class="glyphicon glyphicon-remove"></span>
                              </a></td>
                                      </tr>
